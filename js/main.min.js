...
(function($){
	$(document).ready(function() {
		...
		var modal = $('.modal'),
			...
			modalBackSecond = $('.modal-back-second'),
			testimonials = $('.members__item'),
			textFirst = `Are you ready?!
						 ...
						 You don't know the chances.
						 I'm so blind!`,
		    textSecond = `These are the legs that in circles run
						  ...
						  Some kind of monster
						  This monster lives`,
			textThird = `I push my fingers into my eyes.
		    ...
		    products = [
			{
				...
				cost: 130.00,
				gender: 'men',
				img: 'images/products/nmd/nmd-face.png',
				new: false,
				popular: true,
				all: true,
				vendor: '#01',
				img1: 'images/products/nmd/1.jpg',
				img1icon: 'images/products/nmd/1-min.jpg',
				img2: 'images/products/nmd/2.jpg',
				img2icon: 'images/products/nmd/2-min.jpg',
				img3: 'images/products/nmd/3.jpg',
				img3icon: 'images/products/nmd/3-min.jpg',
				img4: 'images/products/nmd/4.jpg',
				img4icon: 'images/products/nmd/4-min.jpg',
				img5: 'images/products/nmd/5.jpg',
				img5icon: 'images/products/nmd/5-min.jpg' 
			},

			{
				...
				cost: 180.00,
				gender: 'men',
				img: 'images/products/adidas__ultraboost/ultraboost-face.png',
				new: true,
				popular: true,
				all: true,
				vendor: '#02',
				img1: 'images/products/adidas__ultraboost/1.jpg',
				img1icon: 'images/products/adidas__ultraboost/1-min.jpg',
				img2: 'images/products/adidas__ultraboost/2.jpg',
				img2icon: 'images/products/adidas__ultraboost/2-min.jpg',
				img3: 'images/products/adidas__ultraboost/3.jpg',
				img3icon: 'images/products/adidas__ultraboost/3-min.jpg',
				img4: 'images/products/adidas__ultraboost/4.jpg',
				img4icon: 'images/products/adidas__ultraboost/4-min.jpg',
				img5: 'images/products/adidas__ultraboost/5.jpg',
				img5icon: 'images/products/adidas__ultraboost/5-min.jpg'
			},

			{
				...
				cost: 120.00,
				gender: 'men',
				img: 'images/products/yung/yung-face.png',
				new: true,
				popular: false,
				all: true,
				vendor: '#03',
				img1: 'images/products/yung/1.jpg',
				img1icon: 'images/products/yung/1-min.jpg',
				img2: 'images/products/yung/2.jpg',
				img2icon: 'images/products/yung/2-min.jpg',
				img3: 'images/products/yung/3.jpg',
				img3icon: 'images/products/yung/3-min.jpg',
				img4: 'images/products/yung/4.jpg',
				img4icon: 'images/products/yung/4-min.jpg',
				img5: 'images/products/yung/5.jpg',
				img5icon: 'images/products/yung/5-min.jpg'
			},

			{
				...
				cost: 80.00,
				gender: 'men',
				img: 'images/products/continental/face.png',
				new: false,
				popular: true,
				all: true,
				vendor: '#04',
				img1: 'images/products/continental/1.jpg',
				img1icon: 'images/products/continental/1-min.jpg',
				img2: 'images/products/continental/2.jpg',
				img2icon: 'images/products/continental/2-min.jpg',
				img3: 'images/products/continental/3.jpg',
				img3icon: 'images/products/continental/3-min.jpg',
				img4: 'images/products/continental/4.jpg',
				img4icon: 'images/products/continental/4-min.jpg',
				img5: 'images/products/continental/5.jpg',
				img5icon: 'images/products/continental/5-min.jpg'
			},

			{
				title: 'Adidas Crazy BYW',
				cost: 150.00,
				gender: 'men',
				img: 'images/products/crazy/face.png',
				new: true,
				popular: false,
				all: true,
				vendor: '#05',
				img1: 'images/products/crazy/1.jpg',
				img1icon: 'images/products/crazy/1-min.jpg',
				img2: 'images/products/crazy/2.jpg',
				img2icon: 'images/products/crazy/2-min.jpg',
				img3: 'images/products/crazy/3.jpg',
				img3icon: 'images/products/crazy/3-min.jpg',
				img4: 'images/products/crazy/4.jpg',
				img4icon: 'images/products/crazy/4-min.jpg',
				img5: 'images/products/crazy/5.jpg',
				img5icon: 'images/products/crazy/5-min.jpg'
			},

			{
				title: 'Pharrel Williams BBC',
				cost: 130.00,
				gender: 'men',
				img: 'images/products/pharrell/face.png',
				new: true,
				popular: false,
				all: true,
				vendor: '#06',
				img1: 'images/products/pharrell/1.jpg',
				img1icon: 'images/products/pharrell/1-min.jpg',
				img2: 'images/products/pharrell/2.jpg',
				img2icon: 'images/products/pharrell/2-min.jpg',
				img3: 'images/products/pharrell/3.jpg',
				img3icon: 'images/products/pharrell/3-min.jpg',
				img4: 'images/products/pharrell/4.jpg',
				img4icon: 'images/products/pharrell/4-min.jpg',
				img5: 'images/products/pharrell/5.jpg',
				img5icon: 'images/products/pharrell/5-min.jpg'
			},

			{
				...
				cost: 130.00,
				gender: 'men',
				img: 'images/products/pod/face.png',
				new: true,
				popular: true,
				all: true,
				vendor: '#07',
				img1: 'images/products/pod/1.jpg',
				img1icon: 'images/products/pod/1-min.jpg',
				img2: 'images/products/pod/2.jpg',
				img2icon: 'images/products/pod/2-min.jpg',
				img3: 'images/products/pod/3.jpg',
				img3icon: 'images/products/pod/3-min.jpg',
				img4: 'images/products/pod/4.jpg',
				img4icon: 'images/products/pod/4-min.jpg',
				img5: 'images/products/pod/5.jpg',
				img5icon: 'images/products/pod/5-min.jpg'
			},

			{
				title: 'PW Solar HU NMD',
				cost: 250.00,
				gender: 'men',
				img: 'images/products/pw/face.png',
				new: true,
				popular: false,
				all: true,
				vendor: '#08',
				img1: 'images/products/pw/1.jpg',
				img1icon: 'images/products/pw/1-min.jpg',
				img2: 'images/products/pw/2.jpg',
				img2icon: 'images/products/pw/2-min.jpg',
				img3: 'images/products/pw/3.jpg',
				img3icon: 'images/products/pw/3-min.jpg',
				img4: 'images/products/pw/4.jpg',
				img4icon: 'images/products/pw/4-min.jpg',
				img5: 'images/products/pw/5.jpg',
				img5icon: 'images/products/pw/5-min.jpg'
			},

			{
				...
				cost: 75.00,
				gender: 'men',
				img: 'images/products/stan__smith/face.png',
				new: false,
				popular: true,
				all: true,
				vendor: '#09',
				img1: 'images/products/stan__smith/1.jpg',
				img1icon: 'images/products/stan__smith/1-min.jpg',
				img2: 'images/products/stan__smith/2.jpg',
				img2icon: 'images/products/stan__smith/2-min.jpg',
				img3: 'images/products/stan__smith/3.jpg',
				img3icon: 'images/products/stan__smith/3-min.jpg',
				img4: 'images/products/stan__smith/4.jpg',
				img4icon: 'images/products/stan__smith/4-min.jpg',
				img5: 'images/products/stan__smith/5.jpg',
				img5icon: 'images/products/stan__smith/5-min.jpg'
			},

			{
				...
				cost: 120.00,
				gender: 'men',
				img: 'images/products/ultraboost__white/face.png',
				new: false,
				popular: true,
				all: true,
				vendor: '#10',
				img1: 'images/products/ultraboost__white/1.jpg',
				img1icon: 'images/products/ultraboost__white/1-min.jpg',
				img2: 'images/products/ultraboost__white/2.jpg',
				img2icon: 'images/products/ultraboost__white/2-min.jpg',
				img3: 'images/products/ultraboost__white/3.jpg',
				img3icon: 'images/products/ultraboost__white/3-min.jpg',
				img4: 'images/products/ultraboost__white/4.jpg',
				img4icon: 'images/products/ultraboost__white/4-min.jpg',
				img5: 'images/products/ultraboost__white/5.jpg',
				img5icon: 'images/products/ultraboost__white/5-min.jpg'
			}
		],
			memory = '',
			cartMemory = [];
		...
		$('.carousel').on('touchstart', function(event){
		    ...
		    setTimeout(mobileCarouselTxt, 700);
		   
		});

		$('.nav__mobile').click(function(){
			$('.menu__linklist').toggle();
		});

		testimonials.click(function(){
			var a = $(this)[0],
				b = $.inArray(a, testimonials) + 1;

			if (a.classList.length != 2) {
				a.classList.add('active-member');
				testimonials.each(function(i){
					if (testimonials[i] !== a) {
						testimonials[i].classList.remove('active-member');
					} 
				});
			} else {
				return
			...
			if (b == 1) {
				$('.testimonials__txt')[0].classList = 'testimonials__txt first';
				$('.testimonials__txt').text(textFirst);
			} else if (b == 2) {
				$('.testimonials__txt')[0].classList = 'testimonials__txt second';
				$('.testimonials__txt').text(textSecond);
			} else if (b == 3) {
				$('.testimonials__txt')[0].classList = 'testimonials__txt third';
				$('.testimonials__txt').text(textThird);
			}

		});

		$('.products__new').click(function(){
			$('.products__new').addClass(' tab-active');
			$('.products__all').removeClass(' tab-active');
			$('.products__popular').removeClass(' tab-active');
			showProductsNew();
		});

		$('.products__popular').click(function(){
			$('.products__popular').addClass(' tab-active');
			$('.products__all').removeClass(' tab-active');
			$('.products__new').removeClass(' tab-active');
			showProductsPop();
		});

		$('.products__all').click(function(){
			$('.products__all').addClass(' tab-active');
			$('.products__popular').removeClass(' tab-active');
			$('.products__new').removeClass(' tab-active');
			showProductsAll();
		});

		$('.modal__close-holder').click(function(){
			modal.fadeOut();
			modalBack.fadeOut();

		});

		$('.products__list').on('click', 'button', function(){
			var indicators = $('.carousel-indicators li'),
				firstIndicator = indicators[0].classList,
				slides = $('.product__holder-slide'),
				firstSlide = slides[0].classList;

			for (var i = 0; i < indicators.length; i++) {
				if(indicators[i].classList.length > 2) {
				 	var remIndicator = indicators[i].classList; 
				 	remIndicator.remove('active');
				 	firstIndicator.add('.active');
				} 
			}

			for (var i = 0; i < slides.length; i++) {
				if(slides[i].classList.length > 3) { 
				 	var remSlide = slides[i].classList;
				 	remSlide.remove('active');
				 	firstSlide.add('active');
				} 
			}
				
			memory = $(this).attr('name');
			findSingleProduct();
			modal.fadeIn();
			modalBack.fadeIn();
			$('.modal__info-quantity--input').text('0');

		});



		$('.modal__info-size--item').hover(function(){
			var size = $(this).text();
			$('.modal__info-size--view').html(size);
		});

		$('.modal__info-size--selected').click(function(){
			var sizePanel = $('.modal__info-size--hidden');
			sizePanel.toggle('d-none');
		});

		$('.modal__info-size--item').click(function(){
			var size = $(this).html();
			$('.modal__info-size--selected').html(size);
			$('.modal__info-size--hidden').toggle('d-none');
		});

		$('.modal__info-quantity--btnUp').click(function(){
			var q = $('.modal__info-quantity--input');
			q.html( +q.text() + 1);
		});

		$('.modal__info-quantity--btnDown').click(function(){
			var q = $('.modal__info-quantity--input');
			if (+q.text() > 0) {
				q.html( +q.text() - 1);
			} else {
		...
		$('.modal__info-cart').click(function(){
			
			var sizeSelect = $('.modal__info-size--selected').text(),
				quantitySelect = $('.modal__info-quantity--input').text(),
				cart = $('.cart'),
				basket = $('.org__basket-quantity i'),
				basketCost = $('.org__basket-cost i'),
				cartMini = $('.cart-mini'),
				cartInfoQ = $('.cart-info__quantity i'),
				cartInfoCost = $('.cart-info__cost i');
				
			if ( +quantitySelect == 0) {
				alert(`You didn't chose the quantity of a product`);
			} else {
				cartMemory.push(sizeSelect);
				cartMemory.push(quantitySelect);
				
				for (var i = 0; i < products.length; i++) {
					if (products[i].vendor == memory) {
						var elem = `<div class="cart__modal d-flex align-items-start justify-content-between" name="${products[i].vendor}">
										<img src="${products[i].img}">
										<div class="cart__modal-txt d-flex flex-column align-items-end">
											<p class="cart__modal-txt--title">${products[i].title}</p>
										    <p class="cart__modal-txt--cost">$<i>${products[i].cost}</i></p>
										    <p class="cart__modal-txt--size">${cartMemory[cartMemory.length - 2]}</p>
										    <p class="cart__modal-txt--quantity">${cartMemory[cartMemory.length - 1]}</p>
										</div>
										<button class="cart__modal-btn" name="${products[i].vendor}"><i class="fas fa-times"></i></button>
									</div>`;
						cart.append(elem);
						modal.fadeOut();
						modalBack.fadeOut();
						basket.html(+basket.text() + +cartMemory[cartMemory.length - 1]);
						basketCost.html(+basketCost.text() + (products[i].cost * +cartMemory[cartMemory.length - 1]));
						cartInfoQ.html(+cartInfoQ.text() + +cartMemory[cartMemory.length - 1]);
						cartInfoCost.html(+cartInfoCost.text() + (products[i].cost * +cartMemory[cartMemory.length - 1]))
						cartMini.addClass('cart-mini-icon');
		...
		$('.org__cart').click(function(){
			var cartChilds = $('.cart').children();

			if (cartChilds.length == 0) {
				alert(`You didn't add any item in the cart`);
			} else {
				$('.cart-holder').toggle();
				$('.cart-mini').toggleClass('cart-mini-icon');
				$('.cart-mini').toggleClass('cart-mini-show');
				modalBack.css('background', 'rgba(255,255,255,.5)');
				modalBack.toggle();
			}
		...
		$('.cart-info__closeBtn i').click(function(){
			var cartChilds = $('.cart').children();
		...
		$('.cart').on('click', '.cart__modal-btn', function(){
			var basket = $('.org__basket-quantity i'),
				basketCost = $('.org__basket-cost i'),
				quantity = +$(this).prev().find('.cart__modal-txt--quantity').text(),
				cost = +$(this).prev().find('.cart__modal-txt--cost i').text(),
				cart = $('.cart'),
				modalImgHolder = $('.modal__img-holder'),
				cartHolder = $('.cart-holder'),
				cartInfoQ = $('.cart-info__quantity i'),
				cartInfoCost = $('.cart-info__cost i'),
				cartChilds = undefined;

			basket.html(+basket.text() - quantity);
			basketCost.html(+basketCost.text() - cost * quantity);
			cartInfoQ.html(+cartInfoQ.text() - quantity);
			cartInfoCost.html(+cartInfoCost.text() - cost * quantity)
			$(this).parent().remove();
			modalImgHolder.removeClass('slider');

			cartChilds = cart.children();
			if (cartChilds.length == 0) {
				cartHolder.toggle();
				$('.cart-mini').removeClass('cart-mini-show');
				modalBack.toggle();
		...
		$('.cart-mini').click(function(){
			...
			if (cartChilds.length == 0) {
				...
				$('.cart-holder').toggle();
				$(this).toggleClass('cart-mini-icon');
				$(this).toggleClass('cart-mini-show');
				modalBack.toggle();
			};
		...
		$('.cart-info__buyBtn').click(function(){
			var cost = $('.cart-info__cost').text();
			$('.payment__form-cost i').text(cost);
			$('.payment').css('display', 'flex');
			$('.cart-holder').toggle();
			$('.cart-mini').toggleClass('cart-mini-icon');
			$('.cart-mini').toggleClass('cart-mini-show');
			modalBack.toggle();
			modalBackSecond.css('display', 'block');

		})

		$('#pickup').click(function(){
			var elem = `<p class="adress__title">Our adress:</p>
						<p class="adress__main">1 Beacon Avenue, NY, US</p>`;
			$('.payment__form-delivery--select p').html(elem);
			$('#map').css('display', 'block');
		});

		$('#mail-delivery').click(function(){
			var elem = '<input type="text" class="dynamic-input" placeholder="Yor Adress">';
			$('.payment__form-delivery--select p').html(elem);
		...
		$('#cashless').click(function(){
			$('.payment__form-payment--select').css('display', 'flex');
			$('.payment__form-payment--cash').css('display', 'none');
			$('#map').css('display', 'none');
		});

		$('#cash').click(function(){
			$('.payment__form-payment--select').css('display', 'none');
			$('.payment__form-payment--cash').css('display', 'block');
			$('#map').css('display', 'none');
		});

		$('#card-number').mask('0000 0000 0000 0000', {placeholder: 'XXXX XXXX XXXX XXXX'});
		$('#card-validity').mask('00/00', {placeholder: 'XX/XX'});
		$('#card-cvv').mask('000', {placeholder: '***'});
		$('#tel').mask('+(000) 00 0000000', {placeholder: '+(380) 00 0000000'})

		$(document).mouseup(function(e){
			var div = $('.payment');
			if (!div.is(e.target) && div.has(e.target).length === 0) {
				div.css('display', 'none');
				modalBackSecond.css('display', 'none');
			}
		...
		$('.pay-btn').click(function(){
			...
			$('.cart').html('');
			$('.org__basket-cost i').html('0');
			$('.org__basket-quantity i').html('0');
			$('.cart-info__cost i').html('0');
			$('.cart-info__quantity i').html('0');
			modalBack.toggle();
		});

		$('.success-payment__btn').click(function(){
		...
		$('.checkout-btn').click(function(){
			$('.payment').css('display', 'none');
			modalBackSecond.css('display', 'none');
			$('.success-checkout').css('display', 'flex');
			$('.cart').html('');
			$('.org__basket-cost i').html('0');
			$('.org__basket-quantity i').html('0');
			$('.cart-info__cost i').html('0');
		...
		$('.success-checkout__btn').click(function(){
			$('.success-checkout').css('display', 'none');
			modalBack.toggle();
		});

		$('.news__show-btn').click(function(){
			var news = $('.news__items'),
				elem = `<div class="col-12 col-lg-4 col-md-4 news__holder">
							<a href="#" class="news__item">
								<div class="news__item-bg news__item-bg--fourth">
									<p class="news__item-date">Dec 27, 2018</p>
									<p class="news__item-txt">
										Lorem ipsum dolor sit amet, consectetur adipisicing elit.
									</p>
									<p class="news__item-comments"><img src="images/comments.png" alt="comments">24 Comments</p>
									<div class="news__item-hover">
										<div>
											<p>Read More</p>
										</div>
									</div>
						...
						<div class="col-12 col-lg-4 col-md-4 news__holder">
							<a href="#" class="news__item">
								<div class="news__item-bg news__item-bg--fifth">
									<p class="news__item-date">Dec 27, 2018</p>
									<p class="news__item-txt">
										Lorem ipsum dolor sit amet, consectetur adipisicing elit.
									</p>
...
// ------FUNCTIONS------------------------------------------------------------------------
		...
		function showProductsAll() {
			...
			for (var i = 0; i < products.length; i++) {
				if (products[i].all == true) {
					
					var elemProduct = ` <button type="button" class="products__item d-flex flex-column align-items-start justify-content-between" name="${products[i].vendor}">
											<p class="products__item-cost">$${products[i].cost}</p>
											<img src="${products[i].img}" alt="adidas-courtvantage" class="products__item-img">
											<h3 class="products__item-title">${products[i].title}</h3>
											<p class="products__item-vendor">${products[i].vendor}</p>		
										</button>`;
						
					
					list.append(elemProduct);
				} 
			}
		}
		...
		function findSingleProduct() {
			var productHolder = $('.product__holder'),
				infoTitle = $('.modal__info-title'),
				infoGender = $('.modal__info-gender'),
				infoCost = $('.modal__info-cost'),
				vendorCode = $('.modal__info-vendor'),
				first = $('.slide-first'),
				second = $('.slide-second'),
				third = $('.slide-third'),
				fourth = $('.slide-fourth'),
			...
			$('.iFirst').addClass('control00');
			$('.iSecond').addClass('control01');
			$('.iThird').addClass('control02');
			$('.iFourth').addClass('control03');
			$('.iFifth').addClass('control04');

			for (var i = 0; i < products.length; i++) {
				if (products[i].vendor == memory) {
					var elemFirst = `<img src="${products[i].img1}">`,
						elemSecond = `<img src="${products[i].img2}">`,
						elemThird = `<img src="${products[i].img3}">`,
						elemFourth = `<img src="${products[i].img4}">`,
						elemFifth = `<img src="${products[i].img5}">`;

					first.html(elemFirst);
					second.html(elemSecond);
					third.html(elemThird);
					fourth.html(elemFourth);
					fifth.html(elemFifth);
			

					$('.control00').css('background', `url(${products[i].img1icon})`);
					$('.control01').css('background', `url(${products[i].img2icon})`);
					$('.control02').css('background', `url(${products[i].img3icon})`);
					$('.control03').css('background', `url(${products[i].img4icon})`);
					$('.control04').css('background', `url(${products[i].img5icon})`);

					infoTitle.html(products[i].title);
					infoGender.html(products[i].gender);
					infoCost.html(`$${products[i].cost}`);
					vendorCode.html(products[i].vendor);
		...
		function mobileCarousel() {
			var items = $('.members__item');
			if ($(document).width() >= 320 && $(document).width() <= 767) {
				$('.testimonials__members')[0].classList.add('carousel');
				$('.testimonials__members')[0].classList.add('slide');
				$('.testimonials__members-inner')[0].classList.add('carousel-inner');
				items.each(function(i){
					if(items[i].classList.length >= 2) {
						items[i].classList.add('carousel-item');
						items[i].classList.add('active');
						items[i].classList.remove('active-member');
					} else if (items[i].classList.length < 2) {
						items[i].classList.add('carousel-item');
					}
				})
			} else {
		...
		function mobileCarouselTxt() {
			var items = $('.members__item');

			items.each(function(i){
				var d = items[i];
				if (d.classList.length >= 3) {
        ...
        function initMap() {
	        ...
	        marker = new google.maps.Marker({
	 	 		position: {lat:40.576100, lng: -74.123586}, 
	 	 		map: map,
